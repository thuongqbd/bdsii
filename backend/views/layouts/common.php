            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a class="dropdown-toggle" href="#" data-toggle="dropdown"><?= Yii::t('frontend', 'Language')?><b class="caret"></b></a>
                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            ...
                            'items'=>[
								['label'=>Yii::t('product', 'Products'), 'url'=>['/product/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
								['label'=>Yii::t('product_category', 'Product Categories'), 'url'=>['/product-category/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('project', 'Project'), 'url'=>['/project/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                        ...
                        [
                            ...
                            'items'=>[
								...
								['label'=>Yii::t('master_value', 'Master Values'), 'url'=>['/master-value/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
