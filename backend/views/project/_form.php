	...
	<div class="row">
		<div class="col-sm-4">
			<?= $form->field($model, 'city')->widget(\kartik\select2\Select2::classname(), [
				...
				'pluginEvents' => [
					"select2-selected"=>"function() {console.log('select2-selecting city',this.value);Utils.changeAddress('project',this);}",
				]
			]);?>
		</div>
		<div class="col-sm-4">
			...
			echo $form->field($model, 'district')->widget(kartik\depdrop\DepDrop::classname(), [
				...
				'pluginEvents' => [
					"select2-selected"=>"function() {console.log('select2-selecting district',this.value);Utils.changeAddress('project',this);}",
					"select2-removed" => "function() {console.log('select2-removed_dis'); Utils.changeAddress('project',this,2); }",
				]
			]);
			?>
		</div>
		<div class="col-sm-4">
			...
			echo $form->field($model, 'ward')->widget(kartik\depdrop\DepDrop::classname(), [
				...
				'pluginEvents' => [
					"select2-selected"=>"function() {console.log('select2-selecting city',this.value); Utils.changeAddress('project',this); }",
					"select2-removed" => "function() {console.log('select2-removed-ward'); Utils.changeAddress('project',this,2); }",
				]
			]);
			?>
		</div>
	...
	<div class="row">
		<div class="col-sm-4">
			...
			echo $form->field($model, 'street')->widget(kartik\depdrop\DepDrop::classname(), [
				...
				'pluginEvents' => [
					"select2-selected"=>"function() {console.log('select2-selecting street',this.value); Utils.changeAddress('project',this); }",
					"select2-removed" => "function() {console.log('select2-removed-str'); Utils.changeAddress('project',this,2); }",
				]
			]);
			?>
		</div>
