...
Yii::setAlias('@frontendUrl', 'http://yii2-starter-kit.com');
Yii::setAlias('@backendUrl', 'http://backend.yii2-starter-kit.com');
Yii::setAlias('@storageUrl', 'http://storage.yii2-starter-kit.com');