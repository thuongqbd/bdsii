...
class LocaleBehavior extends Behavior
{
	...
	public $usePreferredLanguage = true;
	/**
     * @return array
     */
    ...
    public function beforeRequest()
    {
        if (Yii::$app->getRequest()->getCookies()->has($this->cookieName) && !Yii::$app->session->hasFlash('forceUpdateLocale')) {
            ...
            $userLocale = !Yii::$app->user->isGuest
                ...
                ? Yii::$app->user->getIdentity()->userProfile->locale
                : $this->usePreferredLanguage?Yii::$app->request->getPreferredLanguage(array_keys(Yii::$app->params['availableLocales'])):Yii::$app->language;
        }
