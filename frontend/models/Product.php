...
{	
    ...
    public function rules()
    {
        return [
            ...
            [['product_type', 'product_cate', 'city', 'district', 'ward', 'street', 'project_id', 'price', 'price_type', 'direction', 'balcony_direction', 'floor_number', 'room_number', 'toilet_number', 'ct_phone', 'ct_mobile', 'approved', 'author_id','published', 'deleted', 'created_at', 'updated_at'], 'integer', 'except'=>'frontendSearch'],
            [['area', 'facade', 'entry_width'], 'number', 'except'=>'frontendSearch'],
